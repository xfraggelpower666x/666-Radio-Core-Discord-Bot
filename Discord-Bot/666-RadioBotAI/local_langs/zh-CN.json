{
    ...
    "help": "帮助",
    "Lists all the commands in 666 RadioBotAI.": "列出 666 RadioBotAI 的所有命令。",
    "category": "分类",
    ...
    "view": "查看",
    "List all your playlists and all songs in your favourite playlist.": "列出您所有的播放列表和最喜欢的播放列表中的所有歌曲。",
    "create": "创建",
    ...
    "duplicatetrack": "重复歌曲",
    "Toggle duplicate protection for 666 RadioBotAI.": "切换以防止重复歌曲加入队列。",
    ...
    "togglecontroller": "切换控制器",
    "reset": "重置",
    "Which setting to restore to defaults": "要重置为默认值的设置。",
    "Remove one guild setting override so the bot uses its default again.": "移除一个服务器设置覆盖，使机器人使用其默认值。"
}